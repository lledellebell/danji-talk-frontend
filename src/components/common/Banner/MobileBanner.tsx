...
const MobileBanner: React.FC<MobileBannerProps> = ({ className }) => {
  ...
  return (
    <div className={`${styles['mobile-banner']} ${className || ''}`}>
      ...
      <div className={`${styles['mobile-banner__info-container']} ${isExpanded ? styles['mobile-banner__info-container--expanded'] : ''}`}>
        <div className={styles['mobile-banner__info']}>
          <p>
            <strong>단지톡(Danji Talk)</strong>은 아파트 주민들을 위한 소통 플랫폼입니다. 
            이웃과 함께 정보를 공유하고, 커뮤니티 활동에 참여해보세요.
          </p>
          <p>
