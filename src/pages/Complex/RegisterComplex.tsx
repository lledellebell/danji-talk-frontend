...
const RegisterComplex = () => {
  ...
  const handleDongSettingBackdropClick = (
  ...
  const handleParkingSpacesChange = (
  ...
  const handleStartDongNumberChange = (
    e: React.ChangeEvent<HTMLInputElement>
  ) => {
    const value = e.target.value.replace(/[^0-9]/g, '');
  ...
  const isFormValid =
    complexName && address && households && parkingSpaces && dongInfo;
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className={styles['register-complex__form-group']}>
            ...
            <div className={styles['register-complex__image-container']}>
              ...
              <div
                className={styles['register-complex__image-scroll-container']}
              >
                <div className={styles['register-complex__image-scroll']}>
                  ...
                  {imagePreviewUrls.map((url, index) => (
                    <div
                      key={index}
                      className={styles['register-complex__image-item']}
                    >
                      <img
                        src={url}
                        alt={`단지 이미지 ${index + 1}`}
            ...
            <div className={styles['register-complex__submit-container']}>
              {error && (
                <p className={styles['register-complex__error-message']}>
                  {error}
                </p>
              )}
              <button
        ...
        >
          <div className={styles['register-complex__dong-layer-content']}>
            ...
            <div className={styles['register-complex__dong-layer-preview']}>
              ...
              <div
                className={
                  styles['register-complex__dong-layer-preview-content']
                }
              >
                {previewDongInfo ||
                  '동 수와 시작 동 번호를 입력하면 미리보기가 표시됩니다'}
              </div>
            </div>
